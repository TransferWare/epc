...
extern
			   /*@notnull@ *//*@only@ */
epc__info_t *epc__init (void);

extern void
epc__done ( /*@notnull@ *//*@only@ */ epc__info_t *
	   epc__info) /*@modifies epc__info */ ;

     extern epc__error_t epc__set_logon ( /*@notnull@ */ epc__info_t * epc__info,	/*@null@ */
					 char *logon)
  /*@modifies epc__info->logon */ ;

     extern epc__error_t epc__set_pipe ( /*@notnull@ */ epc__info_t * epc__info,	/*@null@ */
					char *pipe)
  /*@modifies epc__info->pipe */ ;
     ...
     extern long epc__handle_request ( /*@notnull@ */ epc__info_t * epc__info,
				      ...
				      epc__error_t (*recv_request)
				      (epc__info_t *, epc__call_t *),
				      epc__error_t (*send_response)
				      (epc__info_t *, epc__call_t *));
     ...
     extern
       epc__error_t epc__connect ( /*@notnull@ */ epc__info_t * epc__info);

     extern
       epc__error_t epc__disconnect ( /*@notnull@ */ epc__info_t * epc__info);
